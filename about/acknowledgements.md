...
* I've ripped off the [Slate Bootswatch theme](https://bootswatch.com/slate/) and made my own modifications.  Slate gets all the credit, and me all the blame, for the results.
...
* Nothing would be as easy as it is in statistics without the volunteers behind the [R project](https://www.r-project.org/)
* Interactive web apps are hosted commercially in the cloud by [RStudio's shinyapps.io](http://www.shinyapps.io/) platform as a service.  I also make extensive use of open source projects that RStudio and others too numerous to name are related with including [ggvis](http://ggvis.rstudio.com/), [htmlwidgets](http://www.htmlwidgets.org/), [RStudio desktop](https://www.rstudio.com/products/rstudio/).
