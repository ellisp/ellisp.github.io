---
layout: post
title: Seasonal adjusment with X13-ARIMA-SEATS, and {seasonal} and {ggplot2} R packages
date: 2015-10-10
tag: 
   - TimeSeries
   - New Zealand
   - R
description: I show how to seasonally adjust tourist arrivals to New Zealand using the US Census Bureau's excellent X13-ARIMA-SEATS software and the Spanish SEATS algorithm; and how to build a new"stat" for ggplot2 to make it easy to do seasonal adjustment on the fly for a graphic of a time series split by various grouping dimensions.
