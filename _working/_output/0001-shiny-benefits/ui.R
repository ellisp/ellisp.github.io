...
#    tags$head(tags$link(rel = "stylesheet", type = "text/css", href = "http://ellisp.github.io/css/main.css")),
   ...
   sidebarLayout(
      ...
      mainPanel(
         ...
         HTML("<p><i>Source: 
   <a href = 'https://www.msd.govt.nz/about-msd-and-our-work/publications-resources/statistics/benefit/index.html#Datatables6).'>
              Ministry of Social Development</a></i></p>")
      )
   )
))
