...
silver <- function(node_values, edge_values, title, 
                   pal = c("orange", "cyan", "grey95"), family = "myfont",
                   cal_width = 650){
...
#              gp = gpar(fontfamily = family, cex = 1))
   grid.text(x = 0.15, y = 0.15, str_wrap("Source: de Vries (2003), reproduced in Findlay and O'Rourke (2007) 'Power and Plenty'", 30),
...
png("_output/0015-silver-sankey/01.png", 800, 500, res = 100)
   silver(
      ...
      title = "Intercontinental flows of silver, kilograms per year, 1600 to 1650")
dev.off()
...
silver(
   ...
   title = "Intercontinental flows of silver, kilograms per year, 1725 to 1750")
dev.off()
